...
class SubscriptionCanceledDueToPaymentFailure extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Votre abonnement a été annulé suite à un échec de paiement',
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.subscriptions.canceled_due_to_payment_failure',
            with: [
                'user' => $this->user,
