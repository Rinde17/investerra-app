...
<template>
    <AuthenticatedLayout title="Edit Terrain" :breadcrumbs="breadcrumbs">
        <div class="mx-auto max-w-4xl p-4">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Terrain</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update the details of this terrain.</p>
            </div>
