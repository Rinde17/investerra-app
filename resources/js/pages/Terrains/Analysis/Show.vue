...
<template>
  <Head :title="`${terrain.title} - Analysis`" />
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="flex flex-col gap-6 p-4">
      ...
      <div v-if="analysis" class="grid gap-6 md:grid-cols-2">
        ...
        <div v-if="canCompare" class="overflow-hidden rounded-lg border border-sidebar-border/70 bg-white shadow-sm dark:border-sidebar-border dark:bg-sidebar-bg">
          <div class="px-6 py-5">
            <h3 class="text-lg font-medium text-gray-900 dark:text-white">Compare with Other Terrains</h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Select terrains to compare with this one
            </p>
          </div>
          <div class="border-t border-sidebar-border/70 px-6 py-5 dark:border-sidebar-border">
            <div class="mb-4">
            ...
            <div class="mb-4">
              <label for="terrain-select" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Add terrain to comparison:</label>
              <select
                id="terrain-select"
                class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-primary focus:outline-none focus:ring-primary dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm"
                @change="(e) => {
        ...
        <div v-else class="overflow-hidden rounded-lg border border-sidebar-border/70 bg-white shadow-sm dark:border-sidebar-border dark:bg-sidebar-bg">
          <div class="px-6 py-5">
      ...
      <div v-else class="rounded-lg border border-sidebar-border/70 bg-white p-6 shadow-sm dark:border-sidebar-border dark:bg-sidebar-bg">
