...
const totalInvestmentCost = (terrain) => {
  if (!terrain.analysis) {
...
const averageResaleEstimate = (terrain) => {
  if (!terrain.analysis) {
    return 0;
  }
      ...
      <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Compare multiple terrains and their analyses
          </p>
        </div>
      </div>
          ...
          <tbody class="divide-y divide-sidebar-border/70 bg-white dark:divide-sidebar-border dark:bg-sidebar-bg">
            ...
            <tr>
              ...
              <td
                ...
                class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 dark:text-gray-400"
              >
                {{ terrain.analysis ? formatPricePerM2(terrain.analysis.price_m2) : formatPricePerM2(terrain.price / terrain.surface_m2) }}
              </td>
            </tr>
            <tr>
              <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 dark:text-white sm:pl-6">
            ...
            <tr>
              ...
              >
                <span v-if="terrain.analysis" :class="terrain.analysis.price_difference_percentage <= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'">
                  {{ terrain.analysis.price_difference_percentage > 0 ? '+' : '' }}{{ Number(terrain.analysis.price_difference_percentage).toFixed(2) }}%
                </span>
                <span v-else>N/A</span>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td
                ...
                :class="terrain.analysis && terrain.analysis.net_margin_estimate > 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'"
              >
            ...
            <tr>
              ...
              <td
                ...
                :key="terrain.id"
                class="whitespace-nowrap px-3 py-4 text-sm font-semibold"
                :class="terrain.analysis && terrain.analysis.profit_margin_percentage > 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'"
              >
