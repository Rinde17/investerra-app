...
<template>
    <AuthenticatedLayout title="Add Terrain" :breadcrumbs="breadcrumbs">
        <div class="mx-auto max-w-4xl p-6 lg:p-8">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-foreground">Add New Terrain</h1>
                <p class="mt-2 text-base text-muted-foreground">Enter the details of the terrain you want to analyze.</p>
            </div>
            ...
            <div class="overflow-hidden rounded-xl border border-border bg-card shadow-lg">
                <form @submit.prevent="submit" class="p-8">
                    ...
                    <div class="flex items-center justify-end gap-3 border-t border-border pt-6">
                        ...
                        <Button type="submit" :disabled="form.processing" class="bg-primary text-primary-foreground hover:bg-primary/90">
