    ...
    <AuthenticatedLayout title="Edit Project" :breadcrumbs="breadcrumbs">
        <div class="mx-auto max-w-7xl p-4">
            <div class="mb-6">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update the details of your project.</p>
            </div>
            ...
            <form @submit.prevent="submit" class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <div class="lg:col-span-1">
                    ...
                    >
                        <div class="px-6 py-5">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Basic information about your project.</p>
                        </div>
                ...
                <div class="lg:col-span-2">
                    ...
                    >
                        <div class="px-6 py-5">
                            <h2 class="text-lg font-medium text-gray-900 dark:text-white">Manage Terrains</h2>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Select terrains to include in this project.</p>
                        </div>
                        <div class="border-t border-sidebar-border/70 px-6 py-5 dark:border-sidebar-border">
                            <div class="mb-4">
                                <div class="relative">
