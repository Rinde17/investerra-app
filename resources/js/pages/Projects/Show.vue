        ...
        <div class="flex flex-col gap-6 p-4">
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p v-if="project.team" class="mt-1 text-sm text-gray-500 dark:text-gray-400">Team: {{ project.team.name }}</p>
                </div>
                ...
                >
                    ...
                    <div class="border-t border-sidebar-border/70 px-6 py-5 dark:border-sidebar-border">
                        <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                            ...
                            <div class="border-t border-sidebar-border/70 pt-4 sm:col-span-2 dark:border-sidebar-border">
            ...
            <div v-if="activeTab === 'terrains'">
                ...
                >
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="mt-4">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="flex space-x-2">
                                                    <button
                                                        ...
                                                        class="hover:text-primary-dark text-xs font-medium text-primary"
                                                    >
                                                        Edit
                                                    </button>
                                            ...
                                            <div v-if="!editingNotes[terrain.id]" class="mt-1">
                                                <p v-if="terrain.pivot.notes" class="text-sm text-gray-900 dark:text-white">
                                                    {{ terrain.pivot.notes }}
                                                </p>
                                                <p v-else class="text-sm text-gray-400 italic dark:text-gray-500">No notes for this terrain</p>
                                            </div>
                                            <div v-else class="mt-1">
                                                <textarea
                                                    v-model="terrainNotes[terrain.id]"
                                                    rows="3"
                                                    class="dark:bg-sidebar-bg/50 block w-full rounded-md border border-sidebar-border/70 bg-white px-4 py-2 text-sm text-gray-900 shadow-sm focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none dark:border-sidebar-border dark:text-white"
                    ...
                    <div
                        v-else
                        class="flex flex-col items-center justify-center border-t border-sidebar-border/70 p-12 text-center dark:border-sidebar-border"
                    >
                        <svg
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by adding a terrain to this project.</p>
                        <div class="mt-6">
                            <Link
                                :href="route('projects.terrains.add', project.id)"
                                class="hover:bg-primary-dark rounded-md bg-primary px-4 py-2 text-sm font-medium text-white focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:outline-none"
