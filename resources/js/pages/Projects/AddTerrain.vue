...
<template>
  <Head title="Add Terrain to Project" />
    ...
    <div class="mx-auto max-w-7xl p-4">
      <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Add a terrain to your project "{{ project.name }}".
        </p>
      </div>
        ...
        <div class="lg:col-span-2">
          <div class="overflow-hidden rounded-lg border border-sidebar-border/70 bg-white shadow-sm dark:border-sidebar-border dark:bg-sidebar-bg">
            <div class="px-6 py-5">
              ...
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Choose a terrain to add to this project.
              </p>
            </div>
        ...
        <div class="lg:col-span-1">
          <div class="overflow-hidden rounded-lg border border-sidebar-border/70 bg-white shadow-sm dark:border-sidebar-border dark:bg-sidebar-bg">
            <div class="px-6 py-5">
              ...
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Add notes about this terrain in the context of this project.
              </p>
            </div>
            <div class="border-t border-sidebar-border/70 px-6 py-5 dark:border-sidebar-border">
              <div class="mb-6">
